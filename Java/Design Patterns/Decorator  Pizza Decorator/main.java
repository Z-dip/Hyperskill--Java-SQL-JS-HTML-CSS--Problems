...
class TestDrive {
    public static void main(String[] args) {
        ...
        veganPizzaDecor = new Broccoli(veganPizzaDecor/* write your code here */);
        veganPizzaDecor = new Tomato(veganPizzaDecor/* write your code here */);
        veganPizzaDecor = new Spinach(veganPizzaDecor/* write your code here */);
        System.out.println(veganPizzaDecor.getDescription() + " $" + formatSum(veganPizzaDecor.cost()));

        Pizza meatPizzaDecor = new MeatHeaven();
        meatPizzaDecor = new Ham(meatPizzaDecor/* write your code here */);
        meatPizzaDecor = new Chicken(meatPizzaDecor/* write your code here */);
        meatPizzaDecor = new Cheese(meatPizzaDecor/* write your code here */);
